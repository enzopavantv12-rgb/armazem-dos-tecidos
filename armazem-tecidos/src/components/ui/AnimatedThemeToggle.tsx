...
export function AnimatedThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-full border transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-current focus-visible:ring-offset-2 focus-visible:ring-offset-transparent ${className || 'h-12 w-12 border-white/40 text-white hover:bg-white/10'}`}
    >
