  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pt-24 pb-10 text-center">
        ...
        >
          <span className="flex items-center gap-2 rounded-full bg-ambar px-6 py-3 font-medium text-carvao duration-500 ease-in-out group-hover:bg-petroleo-fundo group-hover:text-ambar">
            <img
          ...
          <div className="relative flex h-fit items-center overflow-hidden rounded-full bg-ambar p-[14px] text-carvao duration-500 ease-in-out group-hover:bg-petroleo-fundo group-hover:text-ambar">
            <ArrowUpRight
              aria-hidden="true"
      ...
      <div className="relative z-10 px-6 pb-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          {/* Card esquerdo — com selo de ícone */}
          <div className="relative max-w-sm overflow-hidden rounded-3xl border border-white/25 bg-white/10 p-6 shadow-[0_8px_32px_rgba(0,0,0,0.25),inset_0_1px_1px_rgba(255,255,255,0.5),inset_0_-1px_1px_rgba(255,255,255,0.1)] backdrop-blur-2xl backdrop-saturate-100 backdrop-brightness-105">
            ...
            <div className="relative">
              <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-2xl bg-ambar shadow-sm">
                <Package className="h-5 w-5 text-carvao" aria-hidden="true" />
              </div>
